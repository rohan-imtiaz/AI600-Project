# AI 600 Project 15: Knowledge Distillation (train_student_scratch.py)

# INSTRUCTIONS:
# Run from the 25280058_Project directory:
# python src/train_student_scratch.py
# Trains ResNet-20 from scratch on CIFAR-100 with no teacher (baseline lower bound).
# Best checkpoint is saved to checkpoints/student_scratch.pth.
